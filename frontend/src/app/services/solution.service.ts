...
export class SolutionService {
  ...
  readonly categoryGoalsDatabase: Record<string, { tag: string; title: string; desc: string; goals: { title: string; sub: string; icon: string }[] }> = {
    digital_assessment: {
  ...
  readonly categoryProfileDatabase: Record<string, any> = {
    digital_assessment: {
  ...
  readonly categorySuccessDatabase: Record<string, { tag: string; title: string; desc: string; chips: string[]; placeholder: string }> = {
    digital_assessment: {
  ...
  getGoalsForCategory(catId: string) {
    return this.categoryGoalsDatabase[catId] || this.categoryGoalsDatabase['not_sure'];
  }

  getProfileConfigForCategory(catId: string) {
    return this.categoryProfileDatabase[catId] || this.categoryProfileDatabase['default'];
  }

  getSuccessConfigForCategory(catId: string) {
    return this.categorySuccessDatabase[catId] || this.categorySuccessDatabase['default'];
  }
